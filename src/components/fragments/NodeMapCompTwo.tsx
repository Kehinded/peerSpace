        ...
        >
          ...
          >
            <ForceGraph2D
              ...
              //   //   const linkOpacities: Record<string, number> = {};
              ...
              //   // Animate styles
              //   nodes.forEach((node) => {
              //     const isHighlighted = newHighlightNodes.has(node.id);
              //     const newOpacity = isHighlighted ? 1 : 0.1;
              //     const newRadius = isHighlighted
              //       ? nodeSize * 1.4
              //       : nodeSize * 0.8;
  
              //     animateStyleTransition(
              //       animatedStyles.nodeOpacities[node.id] ?? 1,
              //       newOpacity,
              //       300,
              //       (val) => {
              //         setAnimatedStyles((prev) => ({
              //           ...prev,
              //           nodeOpacities: { ...prev.nodeOpacities, [node.id]: val },
              //         }));
              //       }
              //     );
  
              //     animateStyleTransition(
              //       animatedStyles.nodeRadii[node.id] ?? nodeSize,
              //       newRadius,
              //       300,
              //       (val) => {
              //         setAnimatedStyles((prev) => ({
              //           ...prev,
              //           nodeRadii: { ...prev.nodeRadii, [node.id]: val },
              //         }));
              //       }
              //     );
              //   });
              ...
              //         : link.target.id;
              //     const key = `${sourceId}-${targetId}`;
              //     const isHighlighted = newHighlightLinks.has(key);
